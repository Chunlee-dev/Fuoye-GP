...
public class SecondSemester extends Fragment {
    ...
    private int courseUnit4 = 1;
    private int courseUnit5 = 2;
    ...
    private int courseUnit11 = 1;
    private int courseUnit12 = 2;
                ...
                if (grade1Val == -1 && grade2Val == -1 && grade3Val == -1 && grade4Val == -1 && grade5Val == -1 && grade6Val == -1 && grade7Val == -1 && grade8Val == -1 && grade9Val == -1 && grade10Val == -1 && grade11Val == -1 && grade12Val == -1 && grade13Val == -1 && grade14Val == -1) {
                    ...
                    double currentCgpa =
                            TextUtils.isEmpty(currentCgpaEdt.getText().toString()) ?
                                    0.0 : Double.parseDouble(currentCgpaEdt.getText().toString());

                    double courseUnitsTotal =
                    ...
                    if ((TextUtils.isEmpty(currentCgpaEdt.getText().toString()) && !TextUtils.isEmpty(totalCourseUnitsEdt.getText().toString())) || (!TextUtils.isEmpty(currentCgpaEdt.getText().toString()) && TextUtils.isEmpty(totalCourseUnitsEdt.getText().toString())))
                    {
                        ...
                        coursePointTotal = coursePoint1 + coursePoint2 + coursePoint3 +
                                coursePoint4 + coursePoint5 + coursePoint6 +
                                coursePoint7 + coursePoint8 + coursePoint9 +
                                coursePoint10 + coursePoint11 + coursePoint12 +
                                coursePoint13 + coursePoint14;

                        courseUnitTotal = courseUnit1 + courseUnit2 + courseUnit3 +
                                courseUnit4 + courseUnit5 + courseUnit6 +
                                courseUnit7 + courseUnit8 + courseUnit9 +
                                courseUnit10 + courseUnit11 + courseUnit12 +
                                courseUnit13 + courseUnit14;

                        gp = (coursePointTotal + (currentCgpa * courseUnitsTotal)) / (courseUnitsTotal + courseUnitTotal);
